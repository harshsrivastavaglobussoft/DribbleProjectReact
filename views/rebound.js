...
export default class ReBound extends Component {
  constructor(props){
    super(props);
    this.state = {
      ReboundData :[],
    ...
    return(
      ...
      <ViewPhoto/>
       <View style={styles.tableContainer}>
        <FlatList data={this.state.ReboundData}
  ...
  componentWillMount(){
   ApiModel.sharedInstance()._saveReboundPointer(this);
  }
  componentDidMount(){
    ApiModel.sharedInstance()._dataForReboundTable();
  }

  _UpdateReboundData=(tempData)=>{
     this.setState({
       ReboundData : Array.from(tempData),
     });
  }
...
AppRegistry.registerComponent('ReBound',()=>reBound);
