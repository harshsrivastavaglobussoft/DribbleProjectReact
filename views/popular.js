...
export default class PopularData extends Component {
    ...
    return(
      ...
      <Loader/>
       ...
       <View style={styles.tableContainer}>
        <FlatList data={this.state.PopularTableData}
  ...
  componentWillMount(){
    ApiModel.sharedInstance()._savePopularPointer(this);
  }

  componentDidMount(){
    ApiModel.sharedInstance()._dataForPopularTable();
  }

_UpdatePopularData=(tempData)=>{
 this.setState({
   PopularTableData : Array.from(tempData),
 });
}
...
AppRegistry.registerComponent('PopularData',()=>popularData);
